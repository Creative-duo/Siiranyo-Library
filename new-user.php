...
<body id="books">
    ...
    <div class="books-body">
        ...
        <?php require '_/components/php/functions/validate_newuser.php';?>
      
       <?php include '_/components/php/user-form.php'; ?>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('select#user_privlage').val('<?php echo $_POST['user_privlage'];?>');
